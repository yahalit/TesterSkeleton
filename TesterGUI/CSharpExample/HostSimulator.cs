...
{
    public partial class HostSimulator : Form
    {
        ...
        private void Form1_Load(object sender, EventArgs e)
        {
            ...
            string filePath = @"..\..\PvsHostSetupFile.xlsx";
...
*/
            ...
            using (ExcelPackage package = new ExcelPackage(fileInfo))
            {
                ...
                {
                    // Read the cell value
                    var cellValue = worksheet.Cells[j+1,2].Text;
                    int.TryParse(cellValue, out FaultSimMode[j-1]);
                }
        ...
        public void InitComboBox()
        {
            ...
            for (ind = 0; ind < FailModeNames.Length; ind++)
            {
                comboValve1.Items.Add(FailModeNames[ind]);
                comboValve2.Items.Add(FailModeNames[ind]);
                comboValve3.Items.Add(FailModeNames[ind]);
                comboValve4.Items.Add(FailModeNames[ind]);
                comboValve5.Items.Add(FailModeNames[ind]);
                comboValve6.Items.Add(FailModeNames[ind]);
                comboValve7.Items.Add(FailModeNames[ind]);
                comboValve8.Items.Add(FailModeNames[ind]);
                comboValve9.Items.Add(FailModeNames[ind]);
                comboValve10.Items.Add(FailModeNames[ind]);
                comboValve11.Items.Add(FailModeNames[ind]);
                comboValve12.Items.Add(FailModeNames[ind]);
                comboValve13.Items.Add(FailModeNames[ind]);
                comboValve14.Items.Add(FailModeNames[ind]);
            }
            comboValve1.SelectedIndex = FaultSimMode[0];
            comboValve2.SelectedIndex = FaultSimMode[1];
            comboValve3.SelectedIndex = FaultSimMode[2];
            comboValve4.SelectedIndex = FaultSimMode[3];
            comboValve5.SelectedIndex = FaultSimMode[4];
            comboValve6.SelectedIndex = FaultSimMode[5];
            comboValve7.SelectedIndex = FaultSimMode[6];
            comboValve8.SelectedIndex = FaultSimMode[7];
            comboValve9.SelectedIndex = FaultSimMode[8];
            comboValve10.SelectedIndex = FaultSimMode[9];
            comboValve11.SelectedIndex = FaultSimMode[10];
            comboValve12.SelectedIndex = FaultSimMode[11];
            comboValve13.SelectedIndex = FaultSimMode[12];
            comboValve14.SelectedIndex = FaultSimMode[13];

            comboBoxModeOfAction.Items.Add("Power off");
            comboBoxModeOfAction.Items.Add("Power on Idle");
            comboBoxModeOfAction.Items.Add("Simulation");
            comboBoxModeOfAction.SelectedIndex = 0; 
        ...
        {
            VersionDisplay FV = new VersionDisplay(Interpreter.VersionMsg ) ;
            FV.Show(); 
        }
       ...
       // handler for sending the selected modle set
        ...
        private void comboBoxModeOfAction_SelectedIndexChanged(object sender, EventArgs e)
        {
            ushort value = (ushort)comboBoxModeOfAction.SelectedIndex;
            string SelString = comboBoxModeOfAction.Items[comboBoxModeOfAction.SelectedIndex].ToString() ;
            if (SelString.Contains("Sim") )
            {
                value = (ushort) Literals.E_DeviceMode.DM_SimulationMode;
            }
            Interpreter.SetDeviceMode(isbg: true,  value);
        }
